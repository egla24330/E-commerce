  ...
  return (
    <>
      ...
      <div className="bg-white min-h-screen px-4 py-10 md:px-16 lg:px-32 text-gray-800">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-bold mb-2 text-black">Help Center</h1>
          ...
          <div className="mt-14 border-t pt-6">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-black text-white px-5 py-2 rounded-lg hover:bg-indigo-700 transition"
            >
