    ...
    <div className="bg-white shadow rounded-lg py-6 px-4 md:px-6 space-y-5 border border-gray-200">
        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              onChange={handleInputChange}
              onBlur={handleBlur}
              className={`w-full pl-3 pr-10 py-3 border rounded-lg focus:outline-none focus:ring-2 appearance-none bg-white ${
                errors.subCity ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-blue-200'
              }`}
            >
      ...
      <div>
        ...
        <input
          ...
          onBlur={handleBlur}
          className={`w-full px-3 py-3 border rounded-lg focus:outline-none focus:ring-2 ${
            errors.deliveryLocation ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-blue-200'
          } transition-colors`}
          required
        />
      ...
      <div>
        ...
        <div className={`flex items-center rounded-lg border-2 transition-colors ${
          errors.phone ? 'border-red-500' : 'border-gray-300 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-200'
        }`}>
